...
public class LogAsynClient {
	...
	public static void main(String[] args) throws Exception {
		try {
			...
			Log.AsyncClient asyncClient = new Log.AsyncClient(protocolFactory,
					clientManager, transport);
			System.out.println("Client calls .....   ");
			LogCallback callBack = new LogCallback();
			long currentTime = System.currentTimeMillis();
			asyncClient.log("/mcs/access/", currentTime + "|mcsaccesstestasyn",
					callBack);
			...
			System.out.println(currentTime + " result="
					+ ((Log.AsyncClient.log_call) res).getResult());
