 ...
 *  @generated
 */
package com.discoveryLog.service;
...
public class Log {
	...
	public static class Client extends org.apache.thrift.TServiceClient
		...
		public void send_log(String category, String message)
				throws org.apache.thrift.TException {
	...
	public static class AsyncClient extends
		...
		public void log(
				...
				throws org.apache.thrift.TException {
			checkReady();
			log_call method_call = new log_call(category, message,
		...
		public static class log_call extends
			...
			public void write_args(org.apache.thrift.protocol.TProtocol prot)
				...
				prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage(
						"log", org.apache.thrift.protocol.TMessageType.CALL, 0));
				log_args args = new log_args();
				args.setCategory(category);
				args.setMessage(message);
				args.write(prot);
	...
	public static class log_args implements
		...
		static {
			schemes.put(StandardScheme.class,
					new log_argsStandardSchemeFactory());
		...
		/**
		 * Returns true if field category is set (has been assigned a value) and
		 * false otherwise
		 */
		...
		public int compareTo(log_args other) {
			...
			lastComparison = Boolean.valueOf(isSetCategory()).compareTo(
					typedOther.isSetCategory());
			if (lastComparison != 0) {
				return lastComparison;
			}
			if (isSetCategory()) {
				lastComparison = org.apache.thrift.TBaseHelper.compareTo(
						this.category, typedOther.category);
				if (lastComparison != 0) {
					return lastComparison;
				}
			}
		...
		private static class log_argsStandardScheme extends
			...
			public void read(org.apache.thrift.protocol.TProtocol iprot,
					log_args struct) throws org.apache.thrift.TException {
		...
		private static class log_argsTupleSchemeFactory implements
				SchemeFactory {
	...
	public static class log_result implements
		...
		static {
			schemes.put(StandardScheme.class,
					new log_resultStandardSchemeFactory());
		...
		static {
			...
			metaDataMap = Collections.unmodifiableMap(tmpMap);
			org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
					log_result.class, metaDataMap);
		}

		public log_result() {
		}

		public log_result(int success) {
			this();
		...
		private static class log_resultStandardScheme extends
			...
			public void read(org.apache.thrift.protocol.TProtocol iprot,
					log_result struct) throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
					schemeField = iprot.readFieldBegin();
		...
		private static class log_resultTupleSchemeFactory implements
				SchemeFactory {
		...
		private static class log_resultTupleScheme extends
				TupleScheme<log_result> {
